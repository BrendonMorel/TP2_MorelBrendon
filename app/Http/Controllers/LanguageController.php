...
class LanguageController extends Controller
{
    ...
    public function store(LanguageRequest $request)
    {
        try {
            ...
            $this->languageRepository->create($validatedData);
    ...
    public function show(int $id)
    {
        try {
            ...
            return (new LanguageResource($language))->response()->setStatusCode(OK);
        } catch (ModelNotFoundException $e) {
            return response()->json(['error' => NOT_FOUND_MSG], NOT_FOUND);
        } catch (Exception $ex) {
            return response()->json(['error' => SERVER_ERROR_MSG], SERVER_ERROR);
    ...
    public function index()
    {
        try {
            ...
            return LanguageResource::collection($languages)->response()->setStatusCode(OK);
        } catch (Exception $ex) {
            return response()->json(['error' => SERVER_ERROR_MSG], SERVER_ERROR);
        }
    }
    ...
    public function update(LanguageRequest $request, int $id)
    {
        try {
            ...
            $this->languageRepository->update($id, $validatedData);
